...
Bumping any prompt below requires incrementing PROMPT_VERSION so the Redis
cache invalidates and evals re-run.
"""

from app.schemas.analysis import SectionId

PROMPT_VERSION = "tech-v3"
...
class TechDomain:
    ...
    def section_weights(self) -> dict[SectionId, float]:
        # Used for gap prioritization in the response, never to compute a
        # top-line score.
