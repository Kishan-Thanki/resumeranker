...
- **gRPC Client (Python Engine)**: The `api/internal/analysis` domain acts purely as a gRPC client. Do not implement PDF parsing or LLM calls in Go. Go handles the quotas and forwards the bytes to the Python Engine via `proto/analysis.proto`.
